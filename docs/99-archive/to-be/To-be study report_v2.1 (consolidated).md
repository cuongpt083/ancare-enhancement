...
**Phiên bản:** v2.2 (hợp nhất, cập nhật theo review 2026-06-14). Gộp: To-be v2.0, đặc tả Thu hút & Chuyển đổi (AI), Process State Model, Rà soát rủi ro; **bổ sung phản hồi từ review người dùng (`docs/reviews/20260614-01.md`) và định hướng PO (`docs/reviews/20260614-02.md`)**.
...
> **Thuật ngữ — DMO = Daily Method of Operations:** các hình thức/mô hình kinh doanh của nhóm dinh dưỡng (NDD chuyên sâu, CLB Fit, CLB Yoga, Spa, online…). *(Lưu ý: file review 02 dùng nhầm "Digital Marketing Organization" — trong toàn bộ tài liệu này DMO luôn hiểu theo nghĩa Daily Method of Operations.)*
...
## I.3bis. NĂNG LỰC BỔ SUNG TỪ REVIEW (2026-06-14)

Từ test người dùng (Đức, Mi) và định hướng PO, bổ sung các năng lực sau:

**Trải nghiệm & tư vấn sức khỏe (Lớp Khách hàng — PO ưu tiên cao):**
- **[MỚI] Kịch bản tư vấn nhanh 15 phút:** đo/quét chỉ số cơ thể nhanh + DISC nhanh → bản tư vấn tức thì + **gợi ý gói chương trình phù hợp nhu cầu & tài chính**. (Nâng cấp AC7 thành flow lõi.)
- **[MỚI] Cá nhân hóa theo thể trạng/bệnh lý nền:** AI phân tích chỉ số hằng ngày, khuyến nghị riêng cho người có bệnh nền (thận, phổi, tiểu đường…) thay vì áp dụng đại trà. *(Kèm ràng buộc an toàn y tế — xem Phần IV, R16.)*
- **[MỚI] Quản lý thực đơn + nhật ký + AI nhận diện ảnh bữa ăn:** số hóa thực đơn trực quan; khách chụp ảnh món ăn → AI nhận diện, chấm điểm, theo dõi, làm cơ sở thiết kế thực đơn ngày sau.
- **[MỚI] AnCare Health Score (tính năng "chữ ký"):** điểm sức khỏe 1–100 theo ngày/tuần/tháng, có ngưỡng (vd 1-50 cần cải thiện / 51-70 khá / 71-100 tốt → khuyến khích chia sẻ). Tạo nhận diện độc đáo + động cơ virality.
- **[NÂNG CẤP] Điểm danh/check-in** ghi nhận tham gia (Mi).

**Tương tác AI (giải bài toán "AI phản hồi chậm" + chất lượng):**
- **[MỚI] AI trả lời tức thì theo Skill Script của HLV → tự điều hướng kết nối HLV/Bác sĩ xác thực** sau một khoảng (vd 10–15 phút). Vừa khử độ trễ, vừa giữ vai trò con người.
- **[MỚI] Kiểm duyệt/quản trị chất lượng câu trả lời AI** trước/khi gửi khách (Mi).

**Tích hợp & tiện ích:**
- **[MỚI] Tích hợp dữ liệu thiết bị & health apps** (Garmin, Coros, Apple Health…): import để khách không theo dõi lại từ đầu. *(Khác với "không tích hợp Herbalife" — đây là wearable/health data, hợp lý.)*
- **[MỚI] Tích hợp Google Calendar** cho lịch hẹn 2/1 (đồng bộ, nhắc giờ, tránh trùng) — bổ sung cho AC5.

**Lan tỏa & cộng đồng (mở rộng Content-Attribution):**
- **[MỚI] UGC reward — khách làm KOL/KOC:** điểm thưởng theo nội dung tạo & mức tương tác trên MXH, đổi quà trong hệ sinh thái AnCare.
- **[MỚI] "Chăm sóc chéo" cộng đồng:** HLV trong cùng hệ thống cổ vũ/chúc mừng khách của nhau (thả tim, thông báo khi có kết quả tốt) → gắn kết đội nhóm.

**Vận hành & cải tiến:**
- **[MỚI] Feedback Loop:** tài liệu hướng dẫn chuẩn hóa cho HLV (kèm SRS); kênh ghi nhận lỗi/góp ý (Jira/Sheets) cập nhật real-time.
...
## I.6. LỘ TRÌNH MVP (cập nhật v2.2 — theo ưu tiên PO)

> **Đổi trọng tâm:** PO ưu tiên **giá trị tư vấn & trải nghiệm sức khỏe hằng ngày (Lớp 1–2)** trước phễu thu hút. PSM giữ vai trò nền (làm mỏng từ đầu), nhưng MVP-1 dồn vào "thực chiến tại trạm kết nối".

- **MVP-1 — Tư vấn & Trải nghiệm sức khỏe (lõi PO):** Kịch bản tư vấn nhanh 15 phút (+ gợi ý gói); thực đơn + nhật ký + AI nhận diện ảnh bữa ăn; **AnCare Health Score**; AI trả lời tức thì theo Skill Script → handoff HLV/bác sĩ; nhắc nhở chủ động; PSM/GNV nền mỏng + đo lường; Feedback Loop. *Tận dụng tính năng tracking đã có.*
- **MVP-2 — Học tập, Nội dung & Thu hút:** Module Đào tạo micro-course (21 Talk + Quiz) + gamification, kho nội dung verified; Content-Attribution (mã giới thiệu + phân tích nội dung); DSKHTN số + la bàn phễu; copilot làm ấm/mời (P1–P2); chăm sóc theo dịp; chăm sóc chéo cộng đồng; tích hợp Calendar/wearable.
- **MVP-3 — Phễu lạnh, Matching fallback, Cá nhân hóa, Nhân bản & Sự nghiệp:** chatbot phễu lạnh, matching fallback lead mồ côi, recommender, HOM, coaching tuyến dưới, lộ trình thăng tiến, UGC reward.
...
## F. An toàn nội dung & Yêu cầu phi chức năng (bổ sung từ review)
- **R16 — An toàn y tế (mức CAO):** tư vấn cá nhân hóa theo bệnh lý nền (thận/phổi/tiểu đường…) là **lời khuyên sức khỏe nhạy cảm**. → Bắt buộc **chuyên gia/bác sĩ xác thực** nội dung; có disclaimer "không thay chẩn đoán y khoa"; AI scripted chỉ trong phạm vi an toàn, ca phức tạp **điều hướng sang HLV/bác sĩ**; tuân thủ quy định tư vấn sức khỏe.
- **R17 — Chất lượng & kiểm duyệt câu trả lời AI:** AI gửi nội dung tới khách phải qua kiểm soát (Skill Script giới hạn phạm vi, log, rà soát); tránh thông tin sai.
- **NFR — Độ trễ AI:** phản hồi gần như tức thì (mô hình Skill Script + handoff) để không mất khách do chờ đợi.
- **NFR — Tích hợp wearable:** chuẩn hóa import dữ liệu từ Garmin/Coros/Apple Health; xử lý đồng bộ & quyền riêng tư dữ liệu sức khỏe.
