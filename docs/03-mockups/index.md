...
| `S-CONS-01_pha_bang.html` | US-E02-01 | T1 | progress-dots, list-item | checklist 3 bước phá băng (D10 đội ngũ tự nhập) |
| `S-CONS-02_khao_sat.html` | US-E02-02 | T1 | progress-dots, search | 1 câu/màn, 7 nhóm (D06 DISC ngoài form) |
...
| `S-CONS-06_xu_ly_tu_choi.html` | US-E02-06 | T1+fab | list-item, fab, disclaimer | 5 nhánh phản đối (D07 placeholder) |
