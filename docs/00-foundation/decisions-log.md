...
|---|---|---|---|
| **Q31** | Quy tắc tính RFM (Recency/Frequency/Monetary) + 3 ngưỡng trạng thái (tích cực/có nguy cơ/kém quan tâm)? | ✅ **Đã chốt** (2026-07-02): RFM = R+F+M (0-9). R: hôm nay=3/hôm qua=2/2 hôm=1/quá 3 hôm=0 (cần login+khai báo bữa+tương tác HLV). F: đủ check-in+chat+nhiệm vụ=3, 2/3=2, chỉ check-in=1, không=0. M: Tối ưu=3/Nâng cao=2/Cơ bản=1. Trạng thái: 7-9 tích cực (xanh), 4-6 có nguy cơ (vàng), 0-3 kém quan tâm (đỏ). Quy tắc đầy đủ: `business-rules/Customer-RFM-Scoring-v1.0.md`. ✅ Q31a (R=3 cần cả 3 hoạt động — thiếu 1 → xét ngày gần nhất đủ 3). ✅ Q31b (quan hệ **phân cấp** Chương trình→Gói, không ánh xạ 1-1: M=gói độc lập chương trình). ✅ Danh mục SP 9 tổ hợp đã đề xuất (dựa products-index goals) — `Program-Package-Supplements-v1.0.md`; ⏳ PO xác nhận/điều chỉnh. | US-E01-01, S-LEAD-01; business-rule ✅ |
| **Q32** | Cơ chế attribution người mời khi tạo KH: mặc định HLV đăng nhập, cho đổi sang HLV/KH khác? Quy tắc chống lạm dụng? | ✅ **Đã chốt** (2026-07-02): mặc định = HLV đăng nhập; **cho đổi** sang HLV khác hoặc KH (đại sứ/bảo tố) khác. Quy tắc chống lạm dụng: ghi SĐT người mời + SĐT KH, chống trùng. | US-E01-02, US-E02-08; Content-Attribution Matching |
| **Q33** | Màn “Phá băng” (US-E02-01): giữ là bước app tùy chọn, hay bỏ (chỉ verbal off-app), hay gộp vào Card Chân dung KH? | ✅ **Đã chốt** (2026-07-02): **BỎ màn Phá băng** khỏi luồng app. Nội dung phá băng & xây thiện cảm chuyển vào **kho nội dung đào tạo** (E05 Self-Development). US-E02-01 xóa; S-CONS-01 xóa. | US-E02-01 xóa; S-CONS-01 xóa; E05 bổ sung nội dung |
| **Q34** | Objection Handler (US-E02-06): giữ FAB 5 nhánh (D07) hay chỉ nút “Đóng về DS KH” theo draft? | ✅ **Đã chốt** (2026-07-02): **tạm thời “Đóng về DS KH”** (đơn giản). Quy trình xử lý từ chối cần **tương tác mạnh man-to-man** → hạn chế HLV nhìn vào màn hình. Objection Handler FAB 5 nhánh (D07) **đặt sang P1+ sau** khi có đủ kịch bản. | US-E02-06 (đơn giản hóa), S-CONS-06; D07 về P1+ |
| **Q35** | “Khảo sát mục tiêu” (draft §2.4): là màn riêng giữa Thêm mới KH và Khảo sát Tanita, hay cùng Card Chân dung KH? | ✅ **Đã chốt** (2026-07-02): **gộp vào Card Chân dung KH** (US-E02-02). Không có màn “Khảo sát mục tiêu” riêng. | luồng E02; US-E02-02 |
