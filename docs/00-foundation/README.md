...
| `business-rules/` | Quy tắc nghiệp vụ thật (logic tính toán): `Calorie-Meal-Business-Rules-v1.1.md`, `packaged-service-advice-v1.0.md`, `Consultation-15min-Process-v1.0.md` (quy trình tư vấn 15 phút), `Objection-Handler-Framework-v1.0.md`, `Body-Composition-Standards-v1.0.md`, `Customer-RFM-Scoring-v1.0.md` (chấm điểm RFM khách hàng), `Content-Catalogs-Placeholder-v1.0.md` (DMO/talking point/ánh xạ 12 bước/micro-course — chờ PO). |
