...
> **Tên màn hình:** "**Sức khỏe tổng thể**" (trước đây gọi "Đồng hồ sinh học" — nay là tên *widget trung tâm* trong màn này). Prototype: `prototypes/suc_khoe_tong_the.html`.
...
Prototype: `prototypes/ca_nhan_hoa_thoi_gian_bieu.html`. Truy cập một lần trước khi dùng màn "Sức khỏe tổng thể" (chỉnh lại được).
