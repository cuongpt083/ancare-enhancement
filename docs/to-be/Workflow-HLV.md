...
> ```
>
> Cấu trúc trên đã cập nhật theo **mẫu phiếu Nutrition club** (3 nhóm: đạm/xơ/đường-bột) — logic chi tiết ở `docs/business-rules/Calorie-Meal-Business-Rules-v1.0.md §2.1b`.
