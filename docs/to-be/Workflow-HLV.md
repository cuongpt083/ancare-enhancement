...
> 💬 **Tích hợp Objection Handler:** màn này có **FAB "Khách đang băn khoăn"** — khi KH nêu từ chối (giá / thời gian / "để suy nghĩ"…), HLV bấm để nhận mẫu câu 3 lớp (Thấu hiểu → Lật khung → Tiến tới) cá nhân hóa theo DISC + Stage. Xem `docs/to-be/Objection-Handler_v1.0.md`.

> ❤️ **Tùy chọn Empathy layer:** trình bày bản tư vấn theo **cấu trúc 5 lớp đồng cảm** (Mở đồng cảm → Điểm đang ổn → Điểm cần quan tâm → Nguy cơ giấu sau 1 lớp bấm → Tin vui khả thi), đổi tông theo DISC + Stage. Dành cho khách có nỗi đau sức khỏe & khách đa nghi. Đặc tả: `docs/to-be/Empathy-Consultation_v1.0.md`.
...
> 💬 **Tích hợp Objection Handler:** FAB "Khách đang băn khoăn" cũng có ở màn này (giai đoạn chốt gói thường phát sinh từ chối về giá/ngân sách). Nếu `stage` thấp (Chưa nghĩ tới / Đang cân nhắc), các nhánh chốt gói bị **ẩn**, chỉ hiện gợi ý làm ấm. Xem `docs/to-be/Objection-Handler_v1.0.md`.
...
> 💬 **Tích hợp Objection Handler:** điểm chốt cuối — FAB hỗ trợ xử lý từ chối phút chót (thanh toán/cam kết). Mọi mẫu câu là **gợi ý chỉnh sửa được, không ép**; tinh thần đồng hành, không thu trước gây áp lực. Xem `docs/to-be/Objection-Handler_v1.0.md`.
